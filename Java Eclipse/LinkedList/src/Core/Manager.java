...
//	nodeX.ptr = nodeY;
    ...
    public void checkSameContentLinkedList() {
	if (MyList.isEmpty()) {
	    System.out.println(
	                    "Node List is empty.\nPlease enter input to this List before using this function!");
	    return;
...
//	Node nodeZ = new Node(4);
//	Node nodeX = new Node(7);
//	Node nodeY = new Node(9);
//
//	newLink.head = nodeE;
//	nodeE.ptr = nodeZ;
//	nodeZ.ptr = nodeX;
//	nodeX.ptr = nodeY;
	...
	if (MyList.checkLinkedListSameContent(newLink)) {
	    System.out.println("Both singly Linked list have the same content!");
	} else System.out.println("Contents aren't the same!");
