...
public class Store implements Serializable {
    ...
    public Store() {
        ...
        store.add(new Software("S_002", "Java Hacker", 2.56, 6, 4));
        store.add(new Software("S_001", "Monster Hunter", 38.699, 30, 2));
    }
        ...
        for (ShopItem i : store) {
            if (i.getId().equalsIgnoreCase(remove)) {
                ...
                if (i.getId().charAt(0) == 'B')
                    ...
                    key = "S_";
                // i.getClass().getName() xai de lay ten class
                // store.add(i, new Book(id, name, price, quantity, weight)); co the add vao vi
                // tri cua index i
                System.out.print("Enter id: ");
                StringBuilder sb = new StringBuilder(Validation.checkInputString());
                if ((sb.charAt(0) == 'B' || sb.charAt(0) == 'b' || sb.charAt(0) == 'S' || sb.charAt(0) == 's')
